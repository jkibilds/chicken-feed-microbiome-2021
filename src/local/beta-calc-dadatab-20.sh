...
IN_FTAB=results/dadatab-onlysamples-pmin20Filtered.qza # dadatab minus singletons and nonsense taxons (mito, unassign etc.), minfreq 20.
...
OUTDIR=results/beta-dadatab-20
