...
## Fit MaAsLin2 to SRS-normalized feature table, collapsed at genus level
Taxonomic filter has been applied to remove nonsense taxa. Singletons have been removed and taxonomic classifications have been collapsed at genus level in the input feature table.
```{r, message=FALSE,warning=FALSE,results='hide',fig.keep='all'}
srs_collapsed_LogTransform_dose <- Maaslin2(here("results/dadatab-onlysamples-finalFiltered-srs-collapsed-transp.tsv"),
                     here("data/metadata_samples_Q2_nospaces.tsv"),
